...
youtubeLogo = os.path.join(script_dir, "youtube.png")
...
class YoutubeDownloader():
        ...
        def download_video(self):
                if self.video_url.get() == "":
                        ...
                        messagebox.showerror("Error","Please provide Path")
                                ...
                                self.start_downloading = Label(self.root,text="Video downloading .....",fg="SlateBlue",font=('verdana',10,'bold'),bg="white")
                                ...
                                self.dow_success = Label(self.root,text="Video downloaded successfully .....",fg="SlateBlue",font=('verdana',10,'bold'),bg="white")
        ...
        def download_playlist(self):
                if self.playlist_url.get() == "":
                        ...
                        try:
                                ...
                                self.start_downloading = Label(self.root,text="Playlist downloading .....",fg="SlateBlue",font=('verdana',10,'bold'),bg="white")
                                self.start_downloading.place(x=40,y=10)
        ...
        def __init__(self):
                ...
                self.root['bg']="black"
                self.root.title('Youtube Downloader By S3MAH')
                
                self.l1 = Label(self.root,text="Youtube Downloader By S3MAH",font=('Futura',15,'bold'),bg="white",fg="Tomato")
                self.l1.place(relx=0.5, y=20, anchor='center')

                self.design1 = Label(self.root,bg="Orange",width=20)
                self.design1.place(x=0,y=45)

                self.date = Label(self.root,text=datetime.now(),font=('Futura',10,'bold'),bg="white")
                self.date.place(x=140,y=45)

                self.design2 = Label(self.root,bg="Orange",width=30)
                self.design2.place(x=310,y=45)

                self.design3 = Label(self.root,bg="Orange",width=3,height=8)
                self.design3.place(x=242,y=90)

                self.yt_icon = ImageTk.PhotoImage(Image.open(youtubeLogo, mode="r"))
                self.logo = Label(self.root,image=self.yt_icon,bg="black")
                self.logo.place(x=220,y=70)

                
                # ==================== Download Video ============================

                self.frame1 = LabelFrame(self.root,text="Download Video",width=180,height=180,font=('verdana',10,'bold'),bg="white",fg="SlateBlue",borderwidth=5,relief=SUNKEN,highlightcolor="red",highlightbackground="red")
                ...
                self.video_url = Entry(self.frame1,width=24,relief=SUNKEN,borderwidth=2,bg="LightGray",fg="white")
                ...
                self.video_path = Entry(self.frame1,width=15,relief=SUNKEN,borderwidth=2,bg="LightGray",fg="white")
                ...
                self.frame2 = LabelFrame(self.root,text="Download Playlist",width=180,height=180,font=('verdana',10,'bold'),bg="white",fg="SlateBlue",borderwidth=5,relief=SUNKEN,highlightcolor="red",highlightbackground="red")
                ...
                self.playlist_url = Entry(self.frame2,width=24,relief=SUNKEN,borderwidth=2,bg="LightGray",fg="white")
                ...
                self.playlist_path = Entry(self.frame2,width=15,relief=SUNKEN,borderwidth=2,bg="LightGray",fg="white")
                ...
                self.clear =  Button(self.root,text="Clear",font=('verdana',10,'bold'),bg="white",fg="DodgerBlue",padx=10,relief=RAISED,borderwidth=3,command=self.Clear)
                self.clear.place(x=220,y=195)

                self.quit =  Button(self.root,text="Quit",font=('verdana',10,'bold'),bg="DodgerBlue",fg="white",padx=15,relief=RAISED,borderwidth=3,command=self.Quit)
